              ...
              <div class="card-header">
                <form class="row" action="<?php echo base_url('admin/to-cao/tim-kiem/') ?>"> 
                  <div class="col-sm-2">
                    ...
                    <input type="text" name="nguoitocao" class="form-control" placeholder="Tài khoản người tố cáo" value="<?php echo $post['nguoitocao'] ?>">
                  </div>
                  <div class="col-sm-2">
              ...
              <div class="card-footer clearfix">
                <ul class="pagination pagination-sm m-0 float-right">
                  <?php for($i = 1; $i <= $totalPages; $i++){ ?>
                      <li class="page-item"><a class="page-link" href="<?php echo base_url('admin/to-cao/tim-kiem/'.$i.'/trang/?nguoitocao='.$post['nguoitocao'].'&nguoibitocao='.$post['nguoibitocao']) ?>"><?php echo $i; ?></a></li>
                    <?php } ?>      
                </ul>
              </div>
            </div>
