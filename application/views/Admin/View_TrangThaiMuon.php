        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?php echo base_url('admin/muon-sach/'); ?>">Quản Lý Mượn Sách</a></li>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <select class="form-control" aria-label="Default select example" name="trangthai">
                      ...
                      <option value="1" <?php echo $detail[0]['TrangThai'] == 1 ? "selected" : ""; ?>>Chờ chủ sách duyệt</option>
                      ...
                      <option value="4" <?php echo $detail[0]['TrangThai'] == 4 ? "selected" : ""; ?>>Người mượn đã trả sách</option>
                    </select>
                  </div>
                </div>
              </div> 
              <a class="btn btn-success" href="<?php echo base_url('admin/muon-sach/'); ?>">Quay Lại</a>
