              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control tenchinh" id="ten" placeholder="Tên chuyên mục" name="tenchuyenmuc">
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="duongdan" placeholder="Đường dẫn chuyên mục" name="duongdan">
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
