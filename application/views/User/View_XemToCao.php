        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?php echo base_url('user/to-cao/'); ?>">Quản Lý Tố Cáo</a></li>
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            <form method="post" enctype="multipart/form-data">
              ...
              <a class="btn btn-success" href="<?php echo base_url('user/to-cao/'); ?>">Quay Lại</a>
              <?php if($detail[0]['TrangThai'] == 1){ ?>
                <a class="btn btn-danger" href="<?php echo base_url('user/to-cao/-1/trang-thai/?matocao='.$detail[0]['MaToCao']); ?>">Hủy Tố Cáo</a>
              <?php } ?>
            </form>
          </div>
        </div>
