          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-footer clearfix">
                <a href="<?php echo base_url('user/dong-tien/') ?>" class="btn btn-success">Quay Lại</a>
                <ul class="pagination pagination-sm m-0 float-right">
                  <?php for($i = 1; $i <= $totalPages; $i++){ ?>
                      <li class="page-item"><a class="page-link" href="<?php echo base_url('user/dong-tien/tim-kiem/'.$i.'/trang/?thoigian='.$post['thoigian']) ?>"><?php echo $i; ?></a></li>
                    <?php } ?>      
                </ul>
              </div>
            </div>
