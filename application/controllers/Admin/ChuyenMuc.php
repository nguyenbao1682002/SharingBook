...
class ChuyenMuc extends CI_Controller {
	...
	public function add()
	{
		...
		if ($this->input->server('REQUEST_METHOD') === 'POST') {
			...
			$this->Model_ChuyenMuc->add($tenchuyenmuc,$duongdan,$hinhanh,$hienthitrenmenu);
	...
	public function update($machuyenmuc)
	{
		...
		if ($this->input->server('REQUEST_METHOD') === 'POST') {
			...
			$this->Model_ChuyenMuc->update($tenchuyenmuc,$duongdan,$hinhanh,$hienthitrenmenu,$machuyenmuc);
